...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="container bg-white p-6 rounded-lg shadow-md w-96">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <input type="text" name="name" id="name" required class="border border-gray-300 rounded-lg p-2 mb-4 w-full focus:outline-none focus:ring focus:ring-laravel">

            <label for="password" class="block mb-2">Hasło:</label>
            <input type="password" name="password" id="password" required class="border border-gray-300 rounded-lg p-2 mb-4 w-full focus:outline-none focus:ring focus:ring-laravel">
